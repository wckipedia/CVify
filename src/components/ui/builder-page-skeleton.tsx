...
export function BuilderPageSkeleton() {
  return (
    <div className="min-h-screen pb-8 pt-36 sm:pt-40 lg:pt-24">
      <Skeleton className="fixed left-3 right-3 top-2 mx-auto h-24 max-w-[1600px] rounded-2xl sm:left-4 sm:right-4 sm:top-4 sm:h-14" />
