...
export function Navbar() {
  ...
  return (
    <>
      <div className="no-print fixed inset-x-0 top-4 z-50">
        <div className="mx-auto max-w-[1600px] px-4">
          <GlassPanel
            as="nav"
            className="flex w-full flex-wrap items-center gap-4 px-5 py-3"
          >
        ...
        <div className="flex flex-1 flex-wrap items-center justify-center gap-3">
          <div className="flex items-center gap-2">
            <Label className="mb-0 text-sm normal-case tracking-normal text-neutral-600">
              Template
            </Label>
            <Select
      ...
      {importError && (
        <div
          className="no-print fixed left-1/2 top-24 z-50 -translate-x-1/2 rounded-lg border border-red-500 bg-red-50 px-4 py-2 text-sm text-red-800 shadow-lg"
          role="alert"
        >
          {importError}
          <Button
